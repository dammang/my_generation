...
abstract class AppLocalizations {
  ...
  /// No description provided for @noClaimedProfile.
  ///
  /// In en, this message translates to:
  /// **'This account is not yet linked to a person in the archive.'**
  String get noClaimedProfile;

  /// No description provided for @claimedProfile.
  ///
  /// In en, this message translates to:
  /// **'Linked to {name}'**
  String claimedProfile(String name);

  /// No description provided for @permissionsHeld.
  ///
  /// In en, this message translates to:
